...
//================================================================================
  ...
  *    (0,0)
  */
  #define X_PROBE_OFFSET_FROM_EXTRUDER 00 //change this from your mount // X offset: -left  +right  [of the nozzle]
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 00  //change this from your mount // Y offset: -front +behind [the nozzle]
#endif
